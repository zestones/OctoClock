...
<head>
  ...
  <style nonce="${nonce}">
    ...
    .kpi { background: var(--oc-bg-alt, rgba(255,255,255,.03)); border: 1px solid var(--oc-border); border-radius: 4px; padding: 6px 8px; }
    .kpi-label { font-size: 10px; color: var(--oc-muted); text-transform: uppercase; letter-spacing: .05em; }
    .kpi-value { font-family: var(--oc-font-mono); font-size: 16px; font-weight: 600; color: var(--oc-fg); margin-top: 2px; }
    .kpi-sub   { font-size: 10px; color: var(--oc-desc); margin-top: 1px; }
